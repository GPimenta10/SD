 ...
 *
 * Carrega as configurações do ficheiro config.json e inicializa o servidor
 * que recebe veículos que completam o seu percurso no sistema.
 */
public class SaidaMain {

    /**
     * Ponto de entrada do processo Saída.
     *
    ...
    public static void main(String[] args) {
        ...
        EnviarLogs.enviar(
                TipoLog.SISTEMA,
                String.format("Saída configurada: porta local %d → Dashboard %s:%d",
