...
public class VeiculoNoMapa {
    ...
    private static final double VELOCIDADE_MOTA = 6.0;
    private static final double VELOCIDADE_CARRO = 4.5;
    private static final double VELOCIDADE_CAMIAO = 3.0;
    ...
    /**
     * Classe interna que representa um segmento do trajeto.
     */
