...
public class Veiculo implements Serializable {
    ...
    /**
     * Calcula o tempo total que o veículo permaneceu no sistema (dwelling time).
     * É necessário retirar daqui
     *
     * @return Tempo em milissegundos entre chegada e saída, ou -1 se ainda não saiu
     */
